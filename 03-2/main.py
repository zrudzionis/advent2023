...
input = """............409..........784...578...802......64..............................486.248..............177....................369...............
...
def getNumber(cx, cy):
  ...
  num = ''
  gears = set()
  while xInRange(cx + inc):
    ch = lines[cy][cx + inc]
    if ch.isdigit():
      digitGears = getGears(cx + inc, cy)
      gears.update(digitGears)
      num += ch
      inc += 1
    else:
      break
...
s = 0
for gear, gearNumbers in gearNums.items():
  if len(gearNumbers) == 2:
    s += int(gearNumbers[0]) * int(gearNumbers[1])
